	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			case 3:
				...
				ArrayList<Employee> salary1=app.empService.getEmployeeBySalary(empSal);
				if(salary1.size()>0) {
				System.out.println("The Employees with salary of "+empSal);
				for (Employee salary:salary1) {
					System.out.println(salary);
					System.out.println(" ========================================================");
				}
				}
				else
					System.out.println("The Salary you've entered doesnot belong to any Employee!");
				break;
			case 4:
				System.out.println("Enter Employee's min salary");
				int empSalarymin = Integer.parseInt(sc.nextLine());
				System.out.println("Enter Employee's max salary");
				...
				System.out.println("The Employees who are in the salary Range from"+empSalarymin+" to "+empSalarymax);
				for (Employee salR:salarysRange) {
					...
					System.out.println("There is no salary in the entered range ");
				break;
			case 5:
				System.out.println("Enter Employee Id:");
